...
import {authenticateUserAPI, createAndGradeAttendanceAssignmentsAPI, updateAttendanceScoreAPI} from "./utils/api/api";
...
class App extends Component {
	...
	//createAndGradeAttendanceAssignmentsAPI(body)
